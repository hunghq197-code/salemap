...
- If both are empty, the provider defaults to `gemini-2.5-flash`.
...
- `gemini-2.5-flash` is the recommended starter model because Gemini pricing docs list a free tier for it. `gemini-3.6-flash` may require higher tier/billing access for some projects.
