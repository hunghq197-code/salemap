  ...
  if (!group) {
    return (
      <div className="mx-auto max-w-3xl rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
        <h1 className="text-2xl font-bold text-ink">Khong tim thay nhom lead trung</h1>
        <Link
    ...
    <div className="mx-auto max-w-7xl">
      ...
      <section className="mt-4 rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <p className="mt-3 max-w-3xl text-base leading-8 text-slate-600">
          Hay chon lead chinh de giu lai. Cac ghi chu va lich nhac se duoc chuyen sang lead
          chinh. Lead con lai se duoc luu tru, khong bi xoa vinh vien.
        </p>
        <div className="mt-4 flex flex-wrap gap-2">
          ...
          <span className="inline-flex min-h-8 items-center rounded-full bg-mint/15 px-3 py-1 text-xs font-bold text-ocean">
            {group.leads.length} lead trong nhom
          </span>
        </div>
      </section>
